...
//https://msdn.microsoft.com/en-us/library/ff602034(v=vs.85).aspx
...
namespace HPsUtils
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "ProcHard",
       DefaultParameterSetName = "ProcessName")]
    public class GetProcHardCommand : PSCmdlet
    {
        #region Fields
        /// <summary>
